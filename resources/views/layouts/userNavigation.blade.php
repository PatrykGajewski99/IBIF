    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out" style="padding-left: 50px">
                            <div><strong>{{strtoupper(app()->getLocale())}}</strong></div>
                    ...
                    <x-slot name="content">
                            ...
                            <x-dropdown-link>
                                <a href="{{route(Route::currentRouteName(),'de')}}">DE</a>
                            </x-dropdown-link>
                            <x-dropdown-link>
